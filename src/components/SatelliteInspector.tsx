      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-[#0F233D] border border-[#1E3A5F] rounded-2xl p-5 shadow-xl space-y-4 flex flex-col justify-between">
          <div>
            ...
            <div className="mt-3 bg-[#020C1B] border border-[#1E3A5F] rounded-xl p-3 space-y-2">
              <div className="flex items-center justify-between">
            ...
            {currentScan.groundPhotoExif.physicalStageDetectedPercent !== undefined && (
              <div className="mt-3 bg-[#020C1B] border border-amber-500/30 rounded-xl p-3 space-y-2">
                <div className="flex items-center justify-between">
                ...
                <div className="space-y-1 text-xs">
                  <div className="flex justify-between text-[11px]">
                    ...
                    <span className="text-white font-mono font-bold">100% (Fully Completed)</span>
                  </div>
                  <div className="flex justify-between text-[11px]">
                ...
                {currentScan.groundPhotoExif.missingComponents && (
                  <div className="pt-1 border-t border-[#1E3A5F]/60 space-y-1">
