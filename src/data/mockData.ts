...
export const CONSTITUENCIES: Constituency[] = [
  {
    ...
    scAllocationPercent: 16.4,
    stAllocationPercent: 3.2,
    totalWorks: 34,
    highRiskWorks: 6,
  ...
  },
  {
    ...
    centerLng: 80.9462,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 24.2,
    totalExpenditureCr: 19.5,
    scAllocationPercent: 15.9,
    stAllocationPercent: 4.1,
    totalWorks: 32,
    highRiskWorks: 4,
    flaggedFundsLakhs: 280.0,
  },
  {
    id: 'GORAKHPUR',
    name: 'Gorakhpur',
    ...
    centerLng: 83.3732,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 22.8,
    totalExpenditureCr: 17.1,
    scAllocationPercent: 17.3,
    stAllocationPercent: 2.8,
    totalWorks: 30,
    highRiskWorks: 5,
  ...
  },
  {
    ...
    scAllocationPercent: 12.1,
    stAllocationPercent: 18.5,
    totalWorks: 28,
    highRiskWorks: 4,
  ...
  },
  {
    ...
    centerLng: 76.9366,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 23.9,
    totalExpenditureCr: 18.4,
    scAllocationPercent: 14.8,
    stAllocationPercent: 4.2,
    totalWorks: 33,
    highRiskWorks: 3,
    flaggedFundsLakhs: 210.0,
  },
  {
    id: 'BLR_SOUTH',
  ...
  },
  {
    ...
    centerLng: 76.6394,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 22.4,
    totalExpenditureCr: 16.2,
    scAllocationPercent: 16.5,
    stAllocationPercent: 9.4,
    totalWorks: 29,
    highRiskWorks: 4,
    flaggedFundsLakhs: 265.0,
  },
  {
    id: 'BARAMATI',
    name: 'Baramati',
  ...
  },
  {
    ...
    centerLng: 72.8210,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 24.6,
    totalExpenditureCr: 20.8,
    scAllocationPercent: 15.1,
    stAllocationPercent: 3.5,
    totalWorks: 36,
    highRiskWorks: 4,
    flaggedFundsLakhs: 290.0,
  },
  {
    id: 'PATNA_SAHIB',
    name: 'Patna Sahib',
  ...
  },
  {
    ...
    centerLng: 85.5149,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 21.3,
    totalExpenditureCr: 15.0,
    scAllocationPercent: 19.4,
    stAllocationPercent: 1.8,
    totalWorks: 27,
    highRiskWorks: 4,
    flaggedFundsLakhs: 310.0,
  },
  {
    id: 'NEW_DELHI',
    name: 'New Delhi',
    ...
    centerLng: 77.2090,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 24.8,
    totalExpenditureCr: 21.2,
    scAllocationPercent: 16.0,
    stAllocationPercent: 1.2,
    totalWorks: 38,
    highRiskWorks: 4,
    flaggedFundsLakhs: 310.0,
  },
  {
    ...
    centerLng: 72.6369,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 24.5,
    totalExpenditureCr: 22.0,
    scAllocationPercent: 15.2,
    stAllocationPercent: 8.5,
    totalWorks: 45,
    highRiskWorks: 2,
    flaggedFundsLakhs: 140.0,
  },
  {
    id: 'AHMEDABAD_EAST',
    name: 'Ahmedabad East',
    ...
    centerLng: 72.5714,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 23.7,
    totalExpenditureCr: 18.9,
    scAllocationPercent: 15.6,
    stAllocationPercent: 6.8,
    totalWorks: 35,
    highRiskWorks: 3,
    flaggedFundsLakhs: 215.0,
  },
  {
    id: 'HYDERABAD',
    name: 'Hyderabad',
    ...
    centerLng: 78.4867,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 23.1,
    totalExpenditureCr: 17.8,
    scAllocationPercent: 15.5,
    stAllocationPercent: 4.8,
    totalWorks: 32,
    highRiskWorks: 5,
    flaggedFundsLakhs: 360.0,
  },
  {
    id: 'SECUNDERABAD',
    name: 'Secunderabad',
    ...
    centerLng: 78.4983,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 24.0,
    totalExpenditureCr: 19.3,
    scAllocationPercent: 16.2,
    stAllocationPercent: 5.4,
    totalWorks: 34,
    highRiskWorks: 3,
    flaggedFundsLakhs: 230.0,
  },
  {
    id: 'KOLKATA_NORTH',
    name: 'Kolkata North',
    ...
    centerLng: 88.3639,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 21.4,
    totalExpenditureCr: 15.1,
    scAllocationPercent: 14.2,
    stAllocationPercent: 3.1,
    totalWorks: 29,
    highRiskWorks: 6,
    flaggedFundsLakhs: 430.0,
  },
  {
    id: 'DARJEELING',
    name: 'Darjeeling',
    ...
    centerLng: 88.2663,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 20.8,
    totalExpenditureCr: 14.4,
    scAllocationPercent: 16.8,
    stAllocationPercent: 19.2,
    totalWorks: 28,
    highRiskWorks: 5,
    flaggedFundsLakhs: 325.0,
  },
  {
    id: 'JAIPUR',
    name: 'Jaipur',
    ...
    centerLng: 75.7873,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 22.6,
    totalExpenditureCr: 16.9,
    scAllocationPercent: 17.8,
    stAllocationPercent: 9.2,
    totalWorks: 35,
    highRiskWorks: 4,
    flaggedFundsLakhs: 275.0,
  },
  {
    id: 'JODHPUR',
    name: 'Jodhpur',
    ...
    centerLng: 73.0243,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 23.5,
    totalExpenditureCr: 18.0,
    scAllocationPercent: 18.1,
    stAllocationPercent: 11.4,
    totalWorks: 33,
    highRiskWorks: 4,
    flaggedFundsLakhs: 295.0,
  },
  {
    id: 'BHOPAL',
    name: 'Bhopal',
    ...
    centerLng: 77.4126,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 23.8,
    totalExpenditureCr: 18.0,
    scAllocationPercent: 16.7,
    stAllocationPercent: 14.1,
    totalWorks: 36,
    highRiskWorks: 3,
    flaggedFundsLakhs: 210.0,
  },
  {
    ...
    centerLng: 75.8577,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 24.7,
    totalExpenditureCr: 21.0,
    scAllocationPercent: 16.1,
    stAllocationPercent: 11.2,
    totalWorks: 40,
    highRiskWorks: 2,
    flaggedFundsLakhs: 165.0,
  },
  {
    id: 'GUWAHATI',
    name: 'Guwahati',
    ...
    centerLng: 91.7362,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 20.2,
    totalExpenditureCr: 13.8,
    scAllocationPercent: 13.5,
    stAllocationPercent: 19.4,
    totalWorks: 27,
    highRiskWorks: 5,
    flaggedFundsLakhs: 345.0,
  },
  {
    id: 'SRINAGAR',
    name: 'Srinagar',
    ...
    totalExpenditureCr: 12.4,
    scAllocationPercent: 9.8,
    stAllocationPercent: 12.6,
    totalWorks: 24,
    highRiskWorks: 4,
    flaggedFundsLakhs: 290.0,
  },
  {
    ...
    centerLng: 74.8570,
    totalEntitlementCr: 25.0,
    totalSanctionedCr: 21.5,
    totalExpenditureCr: 15.3,
    scAllocationPercent: 14.5,
    stAllocationPercent: 11.2,
    totalWorks: 28,
    highRiskWorks: 3,
    flaggedFundsLakhs: 220.0,
  }
];
...
export const WORK_ITEMS: WorkItem[] = [
  ...
  {
    id: 'W011',
    code: 'MPLADS/2024-25/DL-DEL-0012',
    title: 'Installation of Solar Micro-Grid & Automated Waste Composting Plant',
    description: 'Decentralized green energy street lighting and organic waste processing facility.',
    category: 'Community Infrastructure',
    constituencyId: 'NEW_DELHI',
    locationName: 'Chanakyapuri, New Delhi',
    lat: 28.5983,
    lng: 77.1932,
    demographicZone: 'GENERAL',
    sanctionedAmountLakhs: 90.0,
    utilizedAmountLakhs: 85.0,
    sanctionDate: '2024-02-15',
    targetCompletionDate: '2024-08-30',
    actualCompletionDate: '2024-09-02',
    status: 'COMPLETED',
    implementingAgency: 'New Delhi Municipal Council (NDMC)',
    contractorName: 'CleanGreen Infra Solutions',
    contractorGstin: '07AABCC8810K1Z1',
    wiriScore: 15,
    riskLevel: 'LOW',
    anomaliesCount: 0,
    flags: []
  ...
  {
    id: 'W012',
    code: 'MPLADS/2024-25/GJ-GAN-0081',
    title: 'Establishment of STEM Robotics & AI Innovation Lab in Govt Polytechnic',
    description: 'Modern robotics laboratory, IoT kits, and digital workstations for technical education.',
    category: 'Education & Schools',
    constituencyId: 'GANDHINAGAR',
    locationName: 'Sector 14, Gandhinagar',
    lat: 23.2300,
    lng: 72.6450,
    demographicZone: 'GENERAL',
    sanctionedAmountLakhs: 110.0,
    utilizedAmountLakhs: 108.0,
    sanctionDate: '2024-01-20',
    targetCompletionDate: '2024-07-31',
    actualCompletionDate: '2024-08-05',
    status: 'COMPLETED',
    implementingAgency: 'Gujarat Urban Development Co (GUDC)',
    contractorName: 'TechVanguard Education LLP',
    contractorGstin: '24AABTE9901M1Z5',
    wiriScore: 19,
    riskLevel: 'LOW',
    anomaliesCount: 0,
    flags: []
  ...
  {
    id: 'W013',
    code: 'MPLADS/2024-25/TS-HYD-0144',
    title: 'Construction of Deep Underground Stormwater Sump & RO Drinking Plant',
    description: '1.5 Lakh Liter water storage sump with multi-stage membrane purification.',
    category: 'Drinking Water',
    constituencyId: 'HYDERABAD',
    locationName: 'Old City, Charminar Zone, Hyderabad',
    lat: 17.3616,
    lng: 78.4747,
    demographicZone: 'GENERAL',
    sanctionedAmountLakhs: 88.0,
    utilizedAmountLakhs: 88.0,
    sanctionDate: '2024-03-10',
    targetCompletionDate: '2024-10-31',
    actualCompletionDate: '2024-11-12',
    status: 'COMPLETED',
    implementingAgency: 'GHMC Engineering Wing',
    contractorName: 'Deccan Aqua Projects Pvt Ltd',
    contractorGstin: '36AABCD4411K1Z2',
    wiriScore: 86,
    riskLevel: 'HIGH',
    anomaliesCount: 2,
    flags: [
      {
        ...
        type: 'CROSS_SCHEME_COLLISION',
        severity: 'CRITICAL',
        title: 'Collision with Mission Bhagiratha Urban Pipeline #MB-HYD-2023',
        description: 'Billed twice on identical water distribution feeder node funded under State Mission in 2023.',
        confidence: 0.94,
  ...
  {
    id: 'W014',
    code: 'MPLADS/2024-25/WB-KOL-0052',
    title: 'Heritage Ghat Pathway Concrete Restoration & Riverfront High Mast Lights',
    description: 'Riverside pathway paving and solar high-mast lighting along Hooghly.',
    category: 'Roads & Bridges',
    constituencyId: 'KOLKATA_NORTH',
    locationName: 'Bagbazar Ghat Environs, Kolkata',
    lat: 22.6020,
    lng: 88.3650,
    demographicZone: 'GENERAL',
    sanctionedAmountLakhs: 74.0,
    utilizedAmountLakhs: 74.0,
    sanctionDate: '2024-02-01',
    targetCompletionDate: '2024-08-31',
    actualCompletionDate: '2024-09-10',
    status: 'COMPLETED',
    implementingAgency: 'Kolkata Municipal Corporation (KMC)',
    contractorName: 'Bengal Heritage Buildtech',
    contractorGstin: '19AABBH7710D1Z9',
    wiriScore: 81,
    riskLevel: 'HIGH',
    anomaliesCount: 2,
    flags: [
      {
        ...
        type: 'DPR_PRICE_INFLATION',
        severity: 'CRITICAL',
        title: 'Decorative Cast Iron Heritage Railings Inflated 62% Above DSR',
        description: 'DPR rates exceed CPWD Kolkata Schedule of Rates by 62%. Overcharge of ₹18.4 Lakhs detected.',
        confidence: 0.96,
        detectedAt: '2024-09-15'
      }
    ]
  },
  // Jaipur
  {
    id: 'W015',
    code: 'MPLADS/2024-25/RJ-JAI-0099',
    title: 'Construction of 20 Community Rainwater Harvesting Kunds in Rural Wards',
    description: 'Traditional water storage kunds with filtration catchments in water-scarce zones.',
    category: 'Drinking Water',
    constituencyId: 'JAIPUR',
    locationName: 'Amer Rural Block, Jaipur',
    lat: 26.9855,
    lng: 75.8513,
    demographicZone: 'ST_MANDATED',
    sanctionedAmountLakhs: 65.0,
    utilizedAmountLakhs: 65.0,
    sanctionDate: '2024-04-10',
    targetCompletionDate: '2024-10-31',
    actualCompletionDate: '2024-11-05',
    status: 'COMPLETED',
    implementingAgency: 'Rural Development & Panchayati Raj Dept, Rajasthan',
    contractorName: 'Marwar Construction Syndicate',
    contractorGstin: '08AABMC3319K1Z4',
    wiriScore: 88,
    riskLevel: 'HIGH',
    anomaliesCount: 2,
    flags: [
      {
        ...
        type: 'CARTEL_BID_RIGGING',
        severity: 'CRITICAL',
        title: 'Front Company Ring: 3 Bidders with Identical PAN & IP Address',
        description: 'All 3 tender applicants originated from same e-procurement session IP and shared managing partner.',
        confidence: 0.95,
        detectedAt: '2024-04-25'
      }
    ]
  },
  // Bhopal
  {
    id: 'W016',
    code: 'MPLADS/2024-25/MP-BHO-0063',
    title: 'Construction of Tribal Skill Training & Multipurpose Community Kendra',
    description: 'Skill development hall, library and sanitation block in tribal habitation.',
    category: 'Community Infrastructure',
    constituencyId: 'BHOPAL',
    locationName: 'Berasia Block, Bhopal',
    lat: 23.6300,
    lng: 77.4300,
    demographicZone: 'ST_MANDATED',
    sanctionedAmountLakhs: 82.0,
    utilizedAmountLakhs: 70.0,
    sanctionDate: '2024-03-01',
    targetCompletionDate: '2024-11-30',
    status: 'IN_PROGRESS',
    implementingAgency: 'MP Rural Road Development Authority (MPRRDA)',
    contractorName: 'Central India Nirman Nigam',
    contractorGstin: '23AABCN5512M1Z8',
    wiriScore: 16,
    riskLevel: 'LOW',
    anomaliesCount: 0,
    flags: []
  ...
  {
    id: 'W017',
    code: 'MPLADS/2024-25/AS-GUW-0028',
    title: 'Brahmaputra Flood Embankment Protection Wall & Geo-Bag Paving',
    description: 'Erosion control retaining wall along riverbank settlement.',
    category: 'Irrigation & Flood Control',
    constituencyId: 'GUWAHATI',
    locationName: 'Pandu Port Environs, Guwahati',
    lat: 26.1520,
    lng: 91.6850,
    demographicZone: 'GENERAL',
    sanctionedAmountLakhs: 135.0,
    utilizedAmountLakhs: 135.0,
    sanctionDate: '2024-01-15',
    targetCompletionDate: '2024-08-15',
    actualCompletionDate: '2024-09-02',
    status: 'COMPLETED',
    implementingAgency: 'Water Resources Dept, Assam',
    contractorName: 'Brahmaputra Civil Infrastructure LLP',
    contractorGstin: '18AABBC6612P1Z0',
    wiriScore: 91,
    riskLevel: 'CRITICAL',
    anomaliesCount: 3,
    flags: [
      {
        ...
        type: 'SATELLITE_GHOST_WORK',
        severity: 'CRITICAL',
        title: 'Sentinel-1 SAR Radar: Zero Embankment Reinforcement Detected',
        description: 'ESA Radar backscatter change is zero. Ground soil profile shows untouched natural silt without concrete/geo-bag protection.',
        confidence: 0.97,
        detectedAt: '2024-09-10'
      }
    ]
  },
  // Srinagar
  {
    id: 'W018',
    code: 'MPLADS/2023-24/JK-SRI-0074',
    title: 'Dal Lake Peripheral Solar Aerators & Bio-Remediation Sewage Line',
    description: 'Distributed solar aerator floats and micro-filtration sewage line.',
    category: 'Sanitation',
    constituencyId: 'SRINAGAR',
    locationName: 'Boulevard Road, Dal Lake, Srinagar',
    lat: 34.0900,
    lng: 74.8400,
    demographicZone: 'GENERAL',
    sanctionedAmountLakhs: 95.0,
    utilizedAmountLakhs: 35.0,
    sanctionDate: '2023-09-10',
    targetCompletionDate: '2024-03-31',
    status: 'LANGUISHING',
    implementingAgency: 'J&K Lakes and Waterways Development Authority (LAWDA)',
    contractorName: 'Kashmir Valley Green Tech LLP',
    contractorGstin: '01AABCK1120B1Z7',
    wiriScore: 78,
    riskLevel: 'HIGH',
    anomaliesCount: 2,
    flags: [
      {
        ...
        type: 'FUND_PARKING_STALL',
        severity: 'CRITICAL',
        title: 'Fund Parking Detected: ₹60 Lakhs Stalled in LAWDA Account for 15 Months',
        description: 'First installment released in Sep 2023; zero physical progress milestone registered on portal.',
        confidence: 0.93,
